    ...
    actions {
      deidentify {
        ...
        transformation_config {
          structured_deidentify_template = count var.input_source_type == "TABLE" ?
                                                google_data_loss_prevention_deidentify_template.table.id
                                              : google_data_loss_prevention_deidentify_template.texte.id
        }
      }
    }
